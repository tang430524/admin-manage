...
import org.bumishi.admin.interfaces.facade.dto.MyProfile;
...
public class UserController {
    ...
    public MyProfile myinfo() {
        return new MyProfile(SecurityUtil.getUser().getUsername(), SecurityUtil.getUser().getEmail());
    }

    @RequestMapping(value = "/profile", method = RequestMethod.PUT)
    public void modifyProfile(@RequestBody ProfileCommand myInfo) {
